...
export const fallbackInterfaceContent: Record<string, string> = {
  ...
  "signup.monthly_commitment_help": "Minimum £43.34/month (equivalent to £10/week). Your regular contribution becomes member credit to spend through the weekly market.",
