...
export const fallbackInterfaceContent: Record<string, string> = {
  ...
  "faq.13.answer": "Your streak measures consecutive weeks of active financial support for the network. It grows by **1 week for each full seven days of funded support**, whether you pay weekly or monthly. A monthly payment keeps your support current for the monthly commitment period; it does not simply add four weeks at once. You do not need to place an order every week for your streak to continue.\n\nDuring an approved pause, or while a regular payment is temporarily overdue within the one-calendar-month grace period, the counter is **frozen**: it does not increase, but it is protected. A missed monthly commitment is treated as a four-week missed-support period for lifecycle purposes, but those weeks are not added to the streak. If the missed payment remains unresolved for a calendar month and no pause has been arranged, the streak ends and progression perks reset.\n\nIf a streak ends, we retain the previous streak number so that exceptional cases can be reviewed and reinstated manually where appropriate.",
  ...
  "dashboard.pause_cancel_scheduled_confirm_heading": "Cancel scheduled pause?",
  "dashboard.pause_cancel_scheduled_confirm_body": "This will remove your upcoming membership pause.",
  "dashboard.pause_end_early_confirm_heading": "End your pause early?",
  "dashboard.pause_end_early_confirm_body": "Your membership will become active again today. Your streak will continue from where it was paused once your regular support resumes, and weekly market emails will resume from their next usual date.",
  "dashboard.pause_keep": "Keep pause",
  "dashboard.pause_confirm_end": "End pause",
  "dashboard.pause_confirm_cancel_scheduled": "Cancel scheduled pause",
