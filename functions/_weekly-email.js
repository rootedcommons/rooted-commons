...
<table role="presentation" width="620" cellspacing="0" cellpadding="0" border="0" style="width:100%;max-width:620px;background:#faf8f1;border-collapse:collapse;">
...
export function weeklyEmailData({member,settings,order,collectionPoint,accessUrl,expiresAt}){
...
export function renderWeeklyEmail({template,member,settings,order,collectionPoint,accessUrl,expiresAt}){
  const data=weeklyEmailData({member,settings,order,collectionPoint,accessUrl,expiresAt});
