...
export function publicMember(member, { collectionPoint = null, lastOrder = null, currentOrder = null, account = null } = {}) {
  ...
  return {
    ...
    lastName: unwrap(member['Last name']),
    email: unwrap(member.Email),
    phone: unwrap(member.Phone),
    weeklyNewsletter: truthy(member['Weekly newsletter'], false),
    ...
    streakCreditedThrough: member['Streak credited through'] || '',
    streakFrozenSince: member['Streak frozen since'] || '',
    ...
    regularCommitmentStoppedAt: member['Regular commitment stopped at'] || '',
