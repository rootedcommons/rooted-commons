...
## Stock Movement
Required: `Product name` (link to Products), `Quantity change`, `Stock Movement` (legacy compatibility), `Movement type`, `Order`, `Order Line`, `Date`, `Idempotency key`, `Reference`, `Notes`, `Active`, `Created by`. Movement type options: `Opening`, `Delivery`, `Order`, `Release`, `Adjustment`, `Wastage`.
...
Required: `Xero Transaction ID`, `Date`, `Imported at`, `Last updated from Xero`, `Amount`, `Direction`, `Type`, `Transaction reference`, `Contact name`, `Xero Contact ID`, `Bank account`, `Member`, `Match status`, `Reconciled`, `Status`, `Included in credit`, `Order`, `Notes`. Match status options: `Matched`, `Unmatched`, `Ambiguous`, `Ignored`. Direction options: `Credit`, `Debit`.
